...
This is a sample Hardhat project to use with the Godot sample(s). This project is required to be launched for those
samples to work.

## Installation

Provided you have a modern `npm` version, you can run (inside this project):
...
With this in mind, the address of the contract is: `0x5FbDB2315678afecb367f032d93F642f64180aa3`.
