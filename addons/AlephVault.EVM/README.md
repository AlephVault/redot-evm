...
`AlephVault.EVM` provides EVM wallet and RPC access for Redot/Godot projects.
...
```text
samples/hardhat-sample.tscn
```

Its script is:

```text
samples/hardhat_sample.gd
```
